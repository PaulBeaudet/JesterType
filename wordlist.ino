//wordlist
//suggestion functions at end of list
//would like them in their own tab 
//however functions depending on progmem variables 
...
void findWord(word wordNumber)//reads a word from the wordlist into the buffer
{
